...
def main():
	...
	ip = ""
	port = ""
	mode = str(input("> press Enter to continue :"))
	if mode == "":
		mode = "cc"
	ip = str(input("> Host (exam: ntt3005.com):"))
	if ip == "":
		print("> Plese enter correct host")
		sys.exit(0)
	if mode == "slow" or mode == "check":
		pass
	else:
		url = str(input("> Page you want to attack(default=/). Exam /home/index.php :"))
		if url == "":
			url2 = "/"
		else:
			url2 = url
